...
tabler_icons = {
    ...
    "brightness": {
        "off": "&#xeb7d;",  # nearest available low state
        "low": "&#xeb7d;",
        "medium": "&#xeb7e;",
        "high": "&#xeb30;",
    },
...
def apply_span(icon_dict: dict) -> dict:
    wrapped: dict = {}
    for key, value in icon_dict.items():
        if isinstance(value, dict):
            wrapped[key] = apply_span(value)
        else:
            wrapped[key] = f"{span}{value}</span>"
    return wrapped


text_tabler_icons = apply_span(tabler_icons)
